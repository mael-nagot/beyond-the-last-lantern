...
6. ✅ `MapPopup` — iterates `generator.secret_walls`; for each whose BOTH endpoints are explored, draws a small "S" centered on the edge boundary in wall-brown. Same fog-of-war rule as door slabs so the hint can't leak past unexplored corridors.
