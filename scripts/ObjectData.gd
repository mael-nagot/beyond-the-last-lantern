...
# Shown instead of locked_message_key when the player clicks a closed
# AND-logic lever-locked door with some (but not all) linked levers
# already pulled. Falls back to locked_message_key when empty.
