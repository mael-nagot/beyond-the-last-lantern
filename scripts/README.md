...
**Key exports:** door_object, key_item, count_min, count_max, lock_id_prefix, door_must_gate_content, key_spawn_locations, key_floor_placement, key_min_distance_to_other_object, door_min_distance_to_other_object, key_to_door_min_distance, key_to_door_max_distance
